...
def init_db():
    try:
        ...
        agregar_columna('ventas', 'archivo_origen', 'TEXT')
        agregar_columna('ventas', 'hoja_origen', 'TEXT')
        agregar_columna('ventas', 'fila_origen', 'INTEGER')
        agregar_columna('ventas', 'hash_fila', 'TEXT')
        agregar_columna('ventas', 'hash_contenido', 'TEXT')

        agregar_columna('importaciones_staging', 'archivo_origen', 'TEXT')
        agregar_columna('importaciones_staging', 'hoja_origen', 'TEXT')
        agregar_columna('importaciones_staging', 'fila_origen', 'INTEGER')
        agregar_columna('importaciones_staging', 'hash_fila', 'TEXT')
        agregar_columna('importaciones_staging', 'hash_contenido', 'TEXT')
        agregar_columna('importaciones_staging', 'nivel_duplicado', "TEXT DEFAULT 'NORMAL'")

        agregar_columna('auditoria_importaciones', 'matriz_conciliacion_json', 'TEXT')
        agregar_columna('auditoria_importaciones', 'etapa0_config_json', 'TEXT')
        agregar_columna('auditoria_importaciones', 'duplicados_confirmados', 'INTEGER DEFAULT 0')
        agregar_columna('auditoria_importaciones', 'duplicados_sospechosos', 'INTEGER DEFAULT 0')
        agregar_columna('auditoria_importaciones', 'diferencia_detectada', 'REAL DEFAULT 0')
        ...
        print(f"[INIT DB ERROR GLOBAL] {e_init}")
